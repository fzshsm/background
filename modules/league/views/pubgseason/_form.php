...
<?php
        ...
        <div class="col-md-8">
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="status" class="col-sm-3 control-label">积分配置</label>
                        <div class="col-sm-5">
                            <?=Html::dropDownList('scoreConfigId' , isset($data['scoreConfigId']) ? $data['scoreConfigId'] : 1 , $ruleConfigList,['id' => 'scoreConfigId']);?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <?=Html::dropDownList('status' , isset($data['status']) ? $data['status'] : 1 , [ 1 => '未开始' , 2 => '进行中' , 3 => '已结束', 4=> '结束且已结算'],['id' => 'status']);?>
                        </div>
                    </div>
    ...
    <div class="form-group default-padding form-button">
        ...
        <a href="<?= Url::to(['/league/pubgseason','leagueId' => $leagueId]) ?>" class="btn btn-default">返　回</a>
    </div>
