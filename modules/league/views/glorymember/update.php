            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 ">
                            <p><?=$data['gameRoleName'];?><a target="_blank" href="<?=Url::to(['/user/update' , 'id' => $data['gameRoleName']])?>" class="btn-lg"><i class="fa fa-pencil-square-o"></i></a></p>
                            <?=Html::hiddenInput("gameRoleName" , isset($data['gameRoleName']) ? $data['gameRoleName']:'')?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <?=Html::hiddenInput("leagueId" , $data['leagueId'])?>
                </div>
            </div>
