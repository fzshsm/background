...
//                    break;
        ...
        <div class="col-xs-2">
            ...
            <?php if(isset($member['roleId'])){?>
                <?= Html::a("<span title=".$member['roleId']." style=".$color.">".$member['roleId']."</span>",Url::to(['/league/glorymember','leagueId' => $model['leagueId'],'searchType' => 'role','content' => $member['roleId']]),['target' => '_blank','data-pjax'=>"0"])?>
            <?php }?>
            <!--
                    段位段位段位段位
            -->
